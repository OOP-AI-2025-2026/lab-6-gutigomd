...
public class Main {
    public static void main(String[] args) {
        ...
        // Заповнюємо даними: (Ціна, Рік, Кінські сили)
        ...
        cars[3] = new Car(5000,  1990, 100); // Найдешевший (за логікою задачі - "найбільший" по ціні)

        System.out.println("=== До сортування ===");
        printCars(cars);

        // Сортуємо масив. Тут автоматично викликається метод compareTo з класу Car
        Arrays.sort(cars);
        ...
        // Тест ручного порівняння двох авто
    ...
    // Допоміжний метод для гарного виводу масиву
